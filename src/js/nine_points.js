...
function NINE_addPlayer(player_name) {
    ...
    var player_score_html = "<div id=\"" + player_id + "\" class=\"players_score idle\" onclick=\"NINE_selectPlayer(this.id, true)\"><p class=\"player_name no_margin\" class=\"no_margin\">" + player_name + "</p><p class=\"players_score no_margin\" class=\"no_margin\">0</p></div>";
